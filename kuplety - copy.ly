...
%% 55
                ...
                \new Lyrics \lyricsto "voice 2" \lyricmode {
                    \override LyricText #'self-alignment-X = #CENTER
                    \set ignoreMelismata = ##t
                     _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ "Со" -- "би" -- "ра" -- "я" "пол" -- _ "ный" "зал!" _ "Со" -- "би" -- "ра" -- "я" "пол" -- _ "ный" "зал!" _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
                    \unset ignoreMelismata
                } % Lyrics 2
            >> % Staff ends
...
%% 55
                ...
                \new Lyrics \with {alignBelowContext="track 4"} \lyricsto "voice 4" \lyricmode {
                    \override LyricText #'self-alignment-X = #CENTER
                    \set ignoreMelismata = ##t
                     "Ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" -- "ту" "ту" -- "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" -- "ту" "ту." "Ди" -- _ "ри" -- "жёр!" "Пам" -- "пам" -- "ту" "ту" -- "ту" -- "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту." "Па" -- "па" -- "па" -- "па." "Э" -- "то" "прос" -- "то" "чу" -- _ "де" -- "са!" _ "Э" -- "то" "прос" -- "то" "чу" -- _ "де" -- "са!" _ "Ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" -- "ту" "ту" -- "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" "ту" -- "ту" -- "ту" "ту." "Он" "кон" -- "цер" -- "том" "пра" -- "вит" "сам," "он" "пра" -- "вит" "сам," "он" "пра" -- _ "вит" "сам!" _ _ "Он" "кон" -- "цер" -- "том" "пра" -- "вит" "сам," "он" "пра" -- "вит" "сам," _ "он" "пра" _ "вит" "сам!" _ "сам!" _ 
                    \unset ignoreMelismata
                } % Lyrics 1
                \new Lyrics \lyricsto "voice 4" \lyricmode {
                    \override LyricText #'self-alignment-X = #CENTER
                    \set ignoreMelismata = ##t
                     _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ "Со" -- "би" -- "ра" -- "я" "пол" -- _ "ный" "зал!" _ "Со" -- "би" -- "ра" -- "я" "пол" -- _ "ный" "зал!" _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
                    \unset ignoreMelismata
                } % Lyrics 2
            >> % Staff ends
